...
output_path = os.path.join(workspace_dir, "scratch", "calculate_opr_data_vols_res.txt")
...
with open(output_path, "w", encoding="utf-8") as f:
    ...
    f.write(f"data sheet Columns: {list(df.columns)}\n")
    f.write(f"data sheet Shape: {df.shape}\n")
    
    # Map province from BC lấy
...
print("Done calculate_opr_data_vols.")
