...
print("🚀 Parsing Truy Thu 2-Week Comparison...")
...
print("✅ SUCCESS: Built and saved 2-Week Truy Thu Comparison to data.json & data.js!")
...
print(f"By Loại count: {len(by_loai_list)} | By AM count: {len(by_am_list)} | Top BC count: {len(top_bc_list)}")
