...
if not os.path.exists(excel_path):
    excel_path = r'C:\\Users\\lap4all\\Downloads\\w35.xlsx'
...
print("SUCCESS: Updated build_data_js.py and data.json/data.js with exact volume values!")
"""

with open('build_data_js.py', 'w', encoding='utf-8') as f:
    f.write(build_script)

# Execute build_data_js.py to regenerate data.json and data.js
os.system('python build_data_js.py')
print("Rebuilt data.json and data.js!")
