...
def build_w38_professional_script():
    ...
    add_speech_section(
        ...
        paragraphs_text=[
            ...
            "2. AM Lê Minh Lợi (Lâm Đồng) — BÁO ĐỘNG ĐỎ SỐ 2: Tỷ lệ %FD Full đạt tới 20,30% (625 đơn hoàn / 3.079 đơn giao, TTS hoàn 17,94%).",
            "3. AM Nguyễn Thanh Long (Khánh Hòa): %FD đạt 11,51% (1.530 đơn hoàn / 13.293 đơn giao, TTS hoàn 10,19%).",
            ...
            "- Bưu cục (LDO) Lang Biang - Đà Lạt 1 (AM Lê Minh Lợi): %FD đạt 20,30% (625 đơn hoàn / 3.079 đơn), tăng mạnh +4,03%p WoW so với W37 (16,26%).",
            "- Bưu cục (KHO) Cam Linh (AM Nguyễn Thanh Long): %FD đạt 16,96%, là BƯU CỤC CÓ SỐ ĐƠN HOÀN LỚN NHẤT TOÀN VÙNG với 988 đơn hoàn / 5.825 đơn, tăng +2,01%p WoW so với W37 (14,96%).",
