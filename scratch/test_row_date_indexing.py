...
for idx, row in df.iterrows():
    ...
    # Primary report date for the entire row is date1 (Col 3)
...
print("=== EXACT MATCH FOR AM NGA (2026-07-23 - Thứ 5) ===")
nga = df_parsed[(df_parsed['AM'] == 'AM Nga') & (df_parsed['Date'] == '2026-07-23 - Thứ 5')]
for bc, sub in nga.groupby('Bưu Cục'):
    ...
    print(f"  TỔNG: Vol {vt} | GTC {gt}\n")

print("=== TOTALS FOR AM NGA (2026-07-23 - Thứ 5) ===")
v1_t = nga[nga['Loại Hàng'] == 'Hàng Mới Ca 1']['Volume'].sum()
g1_t = nga[nga['Loại Hàng'] == 'Hàng Mới Ca 1']['Sản Lượng Giao Thành Công'].sum()
v2_t = nga[nga['Loại Hàng'] == 'Hàng Mới Ca 2']['Volume'].sum()
g2_t = nga[nga['Loại Hàng'] == 'Hàng Mới Ca 2']['Sản Lượng Giao Thành Công'].sum()
v3_t = nga[nga['Loại Hàng'] == 'Hàng Tồn']['Volume'].sum()
g3_t = nga[nga['Loại Hàng'] == 'Hàng Tồn']['Sản Lượng Giao Thành Công'].sum()

print(f"Tổng Vol Ca 1 : {v1_t} | GTC: {g1_t}")
print(f"Tổng Vol Ca 2 : {v2_t} | GTC: {g2_t}")
print(f"Tổng Vol Tồn  : {v3_t} | GTC: {g3_t}")
print(f"TỔNG CỘNG VOL : {v1_t + v2_t + v3_t} | GTC: {g1_t + g2_t + g3_t}")
