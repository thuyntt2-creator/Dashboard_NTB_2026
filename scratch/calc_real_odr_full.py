...
df_full['AM'] = df_full['Chi tiết'].apply(get_am)

# Check unknown
unk = df_full[df_full['AM'] == 'Unknown']['Chi tiết'].unique()
print("Unknown BCs in full:", unk)

# Group by AM for W36 and W37
grp = df_full[df_full['Week'].isin(['W36', 'W37'])].groupby(['AM', 'Week']).agg({'GTC_clean': 'sum', 'vol_ontime': 'sum'}).reset_index()
