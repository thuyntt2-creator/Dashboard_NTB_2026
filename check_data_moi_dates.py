...
# Let's inspect unique dates in data mới and their sums
print("Sums grouped by 'Ngày kết luận truy thu' in data mới:")
summary_by_date = df_moi.groupby('Ngày kết luận truy thu').agg(
